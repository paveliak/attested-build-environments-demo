...
PROC_CMDLINE="root=/dev/sda1 ro rootfstype=ext4 console=tty1 console=ttyS0 earlyprintk=ttyS0 veritydata=/dev/sda1 veritytree=/dev/sda2 verityhash=$(cat rootfs.hash) verityname=verityroot"
