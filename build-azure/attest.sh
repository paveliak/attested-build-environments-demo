...
ATTEST_URL=$(az attestation show --resource-group $AZURE_RESOURCE_GROUP --name $ATTEST_PROVIDER_NAME | jq -r ".attestUri")
...
curl -X PUT -f "$ATTEST_URL/policies/AzureGuest?api-version=2022-08-01" \
